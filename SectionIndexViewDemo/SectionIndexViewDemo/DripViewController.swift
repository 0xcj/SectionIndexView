...
class DripViewController: UIViewController {
...
extension DripViewController: UITableViewDelegate, UITableViewDataSource {
...
extension DripViewController: SectionIndexViewDataSource, SectionIndexViewDelegate {
    ...
    func sectionIndexView(_ sectionIndexView: SectionIndexView, itemPreviewFor section: Int) -> SectionIndexViewItemPreview {
        let preview = SectionIndexViewItemPreview.init(title: indexData[section], type: .drip)
        return preview
    }
