...
extension RectViewController: UITableViewDelegate, UITableViewDataSource {
...
extension RectViewController: SectionIndexViewDataSource, SectionIndexViewDelegate {
    ...
    func sectionIndexView(_ sectionIndexView: SectionIndexView, itemViewAt section: Int) -> SectionIndexViewItem {
        ...
        itemView.titleColor = .red
        itemView.selectedColor = .green
        return itemView
    }
    
    func sectionIndexView(_ sectionIndexView: SectionIndexView, itemPreviewFor section: Int) -> SectionIndexViewItemPreview {
        let preview = SectionIndexViewItemPreview.init(title: indexData[section], type: .rect)
        return preview
    }
